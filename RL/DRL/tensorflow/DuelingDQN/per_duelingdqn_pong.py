...
log_file.write("BATCH_SIZE:{}, MEMORY_SIZE:{},MEMORY_SAMPLE_START:{}\n".format(BATCH_SIZE,MEMORY_SIZE,MEMORY_SAMPLE_START))
log_file.write("MODEL_UPDATE_STEP:{}, MODEL_TRAIN_STEP:{}\n".format(MODEL_UPDATE_STEP,MODEL_TRAIN_STEP))
...
imageio.mimsave(os.path.join(DIR,gifname+'.gif'),images,fps=55)
env.close()
print("Done")